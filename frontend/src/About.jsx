  ...
  return (
    <div className="flex-grow flex items-center justify-center bg-gray-100 p-4">
        <div className="w-full max-w-3xl bg-white shadow-lg rounded-lg p-8 border border-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mb-4 text-center">Key Features</h2>
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mb-4 text-center">Technologies Used</h2>
          <ul className="list-disc list-inside text-gray-600">
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mb-4 text-center">How It Works</h2>
          <p className="text-gray-600 mb-4 text-center">
